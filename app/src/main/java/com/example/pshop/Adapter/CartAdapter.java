...
import com.example.pshop.Helper.ChangeNumberItemsListener;
import com.example.pshop.Helper.ManagmentCart;
import com.example.pshop.databinding.ViewholderCartBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    holder.binding.feeEachItem.setText(listItemSelected.get(position).getPrice()+"đ");
    holder.binding.totalEachItem.setText(Math.round((listItemSelected.get(position).getNumberinCart()*listItemSelected.get(position).getPrice()))+"đ");
