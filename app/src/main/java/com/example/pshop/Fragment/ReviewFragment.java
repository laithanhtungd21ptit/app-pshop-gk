package com.example.pshop.Fragment;
...
import com.example.pshop.Adapter.ReviewAdapter;
import com.example.pshop.Domain.ReviewDomain;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    RecyclerView descTxt=view.requireViewById(R.id.reviewView);
                    if (list.size()>0){
